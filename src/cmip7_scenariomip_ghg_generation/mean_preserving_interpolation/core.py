...
from cmip7_scenariomip_ghg_generation.mean_preserving_interpolation.grouping import get_group_averages
...
def mean_preserving_interpolation(  # noqa: PLR0913
    ...
    y_in: pint.UnitRegistry.Quantity,
    x_bounds_out: pint.UnitRegistry.Quantity,
    algorithm: MeanPreservingInterpolationAlgorithmLike,
